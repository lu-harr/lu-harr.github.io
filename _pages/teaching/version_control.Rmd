...
One widely-used system for version control is [**git**](https://en.wikipedia.org/wiki/Git). Here are some words we're going to be using:

- "repository" or "repo": think of this as a folder where all your code and other stuff goes. Each repo is a self-contained unit for a single project.
