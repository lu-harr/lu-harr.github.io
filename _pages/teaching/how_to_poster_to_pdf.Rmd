...
urlcolor: blue # Or any other color
---
...
knitr::include_graphics("how_to_poster_files/reading_direction.png", error = FALSE)
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("how_to_poster_files/graphs.png", error = FALSE)
```

Another example - here's a figure I put in [this paper](https://doi.org/10.1098/rsos.230641):

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("how_to_poster_files/rsos230641f04.jpg", error = FALSE)
```

... and here's what the same information looked like when I presented the project as a poster:  

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("how_to_poster_files/MiM_poster.png", error = FALSE)
```
