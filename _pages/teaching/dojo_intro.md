...
*This tutorial is for the first session of the IDDO Data Dojo, a
recurring workshop to discuss research/data skills and shortcuts. In
this tutorial, we initialise a GitHub repository for the data dojo and
get everyone set up.*

Before we start, we need everyone to:

- Have `Git` installed. (`Git` comes with macs/linux, but Windows users
  will need to download). To check `Git` is installed, in your terminal,
  type: `git version`
...
- Our Coding Club’s intro to GitHub
  [tutorial](https://ourcodingclub.github.io/tutorials/git/)
- Our Coding Club’s
